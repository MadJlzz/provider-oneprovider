...
import (
	...
	clusterv1beta1 "github.com/MadJlzz/provider-oneprovider/apis/cluster/v1beta1"
	namespacedv1beta1 "github.com/MadJlzz/provider-oneprovider/apis/namespaced/v1beta1"
)
...
const (
	...
	errUnmarshalCredentials = "cannot unmarshal oneprovider credentials as JSON"
)
...
func TerraformSetupBuilder(version, providerSource, providerVersion string) terraform.SetupFn {
	return func(ctx context.Context, client client.Client, mg resource.Managed) (terraform.Setup, error) {
		...
		if v, ok := creds[keyClientKey]; ok {
			ps.Configuration[keyClientKey] = v
		}
